...
// Assessor function that returns the maximum velocity alloted for a character
const float & MovementComponent::getMaximumVelocity() const
{
	return this->maximumVelocity;
}

// Assessor function that returns the current velocity for a character
const sf::Vector2f & MovementComponent::getVelocity() const
{
	return this->velocity;
}

// Evaluates what type of movement the character is doing
...
// Handles changing movement velocity  for a character by accelerating it based on distance traveled. 
...
// Updates the movement of a character based on the direction that they are traveling. 
